//
//  UIContactsTableViewController.m
//  MetlifePresentadorIpad
//
//  Created by Cristopher Adán Bautista Gómez on 14/10/15.
//
//
...
@interface UIContactsTableViewController ()
...
-(void)showAddressBook{
    ...
    [self presentViewController:_addressBookController animated:NO completion:^{
    }];
}
...
-(void)peoplePickerNavigationControllerDidCancel:(ABPeoplePickerNavigationController *)peoplePicker{
    [_addressBookController dismissViewControllerAnimated:NO completion:^{
        // Return to WebView
